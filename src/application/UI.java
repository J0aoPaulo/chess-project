...
public class UI {
    ...
    private static void printWhiteCapturedPieces(List<ChessPiece> white) {
    ...
    private static void printBlackCapturedPieces(List<ChessPiece> black) {
    ...
    private static void printCapturedPieces(List<ChessPiece> captured) {
        ...
        printWhiteCapturedPieces(white);
        printBlackCapturedPieces(black);
    }
}